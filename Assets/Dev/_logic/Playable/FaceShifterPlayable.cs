...
namespace AnimLite.DancePlayable
{
    ...
    public class FaceShifterPlayable : PlayableBehaviour
    {
        ...
        public static ScriptPlayable<FaceShifterPlayable> Create(
            PlayableGraph graph, Animator anim, IKeyFinderWithoutProcedure<float> kf, StreamingFace face, StreamingTimer timer)
        {
        ...
        public void Initialize(Animator anim, IKeyFinderWithoutProcedure<float> kf, StreamingFace face, StreamingTimer timer)
        {
            this.kf = kf;
            this.timer = timer;
            this.indexBlockTime = kf.IndexBlockTimeRange;
            this.opface = anim.ToVmdFaceOperator(face);
        }
