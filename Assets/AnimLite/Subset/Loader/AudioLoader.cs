...
namespace AnimLite.Utility
{
    ...
    static public class AudioLoader
    {
        ...
        // �I�[�f�B�I�̓X�g���[�����炾�� audio clip �ɂł��Ȃ��i�f�R�[�h�����Ƃ������Ȃ��Ƃ����Ȃ��j�̂ŁA���̃��f�B�A�ƈႤ����
        // unity �� UnityWebRequestMultimedia �� addressables ���A�̂Q�ʂ�
        // ������ zip �� stream ����̕��@���Ƃ������߁A�������� tmp file �ɂ��Ă��� UnityWebRequestMultimedia �œǂ܂��Ă���
