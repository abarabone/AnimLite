...
namespace AnimLite.Utility
{
        ...
        where T : class
    {
        ...
        {
            //$"dispose instance {this.Value.AsUnityNull()?.name}/{typeof(T).Name}/{this.Prototype.GetType().Name}".ShowDebugLog();
            var value = this.Value;
            this.Value = null;
            return this.Prototype.ReleaseWithDestroyAsync(value);
        }
